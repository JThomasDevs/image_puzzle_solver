...
def process_image(image_path):
    """Process an image through the API server and display the annotated result"""
    try:
        ...
        save_base64_image(result['annotated_image_b64'], temp_path)
...
if __name__ == "__main__":
    ...
    test_image = "backend/data/images/unprocessed/car_on_street_11.jpg"  # Using an unannotated image
